...
x4=3:0.1:10;
%a fost creat vectorul abscisa x4 ale carui elemente apartin intervalului [3;10]
y4=x4*0+12.5;
%a fost creat vectorul ordonata y4 care are valoare constanta
...
hold on;
%se activeaza mecanismul de suprapunere succesiva a graficelor

plot(x4,y4,'Color','g','LineWidth',3);
%reprezentarea grafica a functiei in coordonate liniare cu linie de culoare verde si de grosime 3

hold off;
%se dezactiveaza mecanismul de suprapunere succesiva a graficelor